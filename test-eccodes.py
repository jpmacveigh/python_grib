...
def valeur_now (code_model,code_param,code_type_niv,longitude,latitude,niveau):
    ...
    message_avant=grib_messages_avant[0]
    message_apres=grib_messages_apres[0]
...
def get_vent_horizontal_now (code_model,code_type_niv,longitude,latitude,niveau):
    dd=valeur_now(code_model,"WDIR",code_type_niv,longitude,latitude,niveau)
    ff=valeur_now(code_model,"WIND",code_type_niv,longitude,latitude,niveau)
    rep={}
    rep["run"]=dd["run"]
...
print (valeur_now("arpege-world","TMP","2m",lieu[0],lieu[1],0))
print (valeur_now("arpege-world","PRES","msl",lieu[0],lieu[1],0))
#print (valeur_now("arpege-world","UGRD","10m",lieu[0],lieu[1],0))
#print (valeur_now("arpege-world","VGRD","10m",lieu[0],lieu[1],0))
#print (valeur_now("arpege-world","WDIR","10m",lieu[0],lieu[1],0))
#print (valeur_now("arpege-world","WIND","10m",lieu[0],lieu[1],0))
